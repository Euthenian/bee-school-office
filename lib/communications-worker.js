...
export async function processQueuedCommunicationActions({
  ...
  for (const action of actions) {
    ...
    try {
      const result = await processIntegrationAction({ action, calendarProvider, emailProvider });
...
async function processIntegrationAction({ action, calendarProvider, emailProvider }) {
