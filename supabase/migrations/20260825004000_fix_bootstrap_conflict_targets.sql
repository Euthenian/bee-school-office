...
begin
  ...
  on conflict on constraint organization_memberships_organization_id_profile_id_key do update
  set role = 'super_admin',
      updated_at = now();

  insert into public.school_memberships (school_id, profile_id, role)
  values (v_school_id, p_admin_user_id, 'school_manager')
  on conflict on constraint school_memberships_school_id_profile_id_key do update
