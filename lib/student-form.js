...
export function createStudentEditState(student, finance = {}) {
  ...
  const monthlyFeeYen =
    finance?.monthly_fee_yen === null || finance?.monthly_fee_yen === undefined ? "" : stringifyValue(finance.monthly_fee_yen);
  ...
  return {
    form: {
      ...
      billingPlanId: finance?.billing_plan_id || "",
      monthlyFeeYen,
      classAssignmentMode: classId ? "existing" : "new",
      classId,
